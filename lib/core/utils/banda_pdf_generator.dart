            ...
            children: [
              ...
              pw.Column(
                children: s.components.map((c) {
                  final opcionesFijas = _obtenerOpcionesFijasParaComponente(c.name);
                  return pw.Container(
                    height: 14,
                    ...
                    child: _buildOptionsInRow(opcionesFijas, c.selectedOptionId),
                  );
                }).toList(),
              ),
              pw.Column(
  ...
  static pw.Widget _buildOptionsInRow(List<BandaOption> options, String? selectedOptionId) {
    ...
    return pw.Row(
      ...
      children: List.generate(options.length, (index) {
        ...
        final bool isSelected = opt.value.trim().toLowerCase() == selectedOptionId?.trim().toLowerCase();
