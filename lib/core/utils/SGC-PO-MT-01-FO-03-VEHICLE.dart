...
class VehiculoPdfGenerator {
  ...
  // --- MÉTODO PARA PRECARGAR IMÁGENES USANDO DIO ---
  ...
  static pw.Widget _buildInspectionTable(String title, List<dynamic> items) => pw.Table(
    ...
    columnWidths: {0: const pw.FlexColumnWidth(3), 1: const pw.FixedColumnWidth(28), 2: const pw.FixedColumnWidth(28), 3: const pw.FixedColumnWidth(28), 4: const pw.FixedColumnWidth(28), 5: const pw.FlexColumnWidth(2), 6: const pw.FixedColumnWidth(30), 7: const pw.FixedColumnWidth(30)},
    children: [
