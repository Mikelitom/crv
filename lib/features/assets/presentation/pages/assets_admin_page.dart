...
class _AssetsAdminPageState extends ConsumerState<AssetsAdminPage> {
  ...
  Widget _buildList(
    ...
    final filtered = items.where((item) {
      ...
      if (type == "vehiculo")
        return (item.plate?.toLowerCase() ?? "").contains(q);
  ...
  List<DataColumn> _buildTableColumns(String type) {
    ...
    if (type == "cliente") {
      return const [
        DataColumn(
          label: Expanded(child: Text("NOMBRE", style: headerStyle)),
        ),
        DataColumn(
          label: Expanded(child: Text("COMPAÑÍA", style: headerStyle)),
        ),
        DataColumn(
          label: Expanded(child: Text("TELÉFONO", style: headerStyle)),
        ),
        DataColumn(
          label: Expanded(child: Text("EMAIL", style: headerStyle)),
        ),
      ...
      return const [
        DataColumn(
          label: Expanded(child: Text("MARCA", style: headerStyle)),
        ),
        DataColumn(
          label: Expanded(child: Text("MODELO", style: headerStyle)),
        ),
        DataColumn(
          label: Expanded(child: Text("AÑO", style: headerStyle)),
        ),
        DataColumn(
          label: Expanded(child: Text("PLACA", style: headerStyle)),
        ),
        DataColumn(label: Text("ACCIONES", style: headerStyle)),
      ];
    } else {
      return const [
        DataColumn(
          label: Expanded(child: Text("TIPO", style: headerStyle)),
        ),
        DataColumn(
          label: Expanded(child: Text("MODELO", style: headerStyle)),
        ),
        DataColumn(
          label: Expanded(child: Text("VOLTAJE", style: headerStyle)),
        ),
        DataColumn(
          label: Expanded(child: Text("SERIE", style: headerStyle)),
        ),
        DataColumn(
          label: Expanded(child: Text("TAMAÑO", style: headerStyle)),
        ),
        DataColumn(label: Text("ACCIONES", style: headerStyle)),
      ];
    }
