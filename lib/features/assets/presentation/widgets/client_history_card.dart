...
class _ClientHistoryCardState extends State<ClientHistoryCard> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (selected.material.isNotEmpty ||
              selected.granulometry.isNotEmpty) ...[
            Container(
  ...
  Widget _infoContainer() {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: _infoRow(Icons.person_outline, selected.inspectorName),
          ),
          const SizedBox(width: 6),
          Expanded(
            child: _infoRow(
              Icons.calendar_today_outlined,
              DateFormat('dd/MM/yyyy').format(selected.inspectionDate),
            ),
          ),
          const SizedBox(width: 6),
          Expanded(
            child: _infoRow(
              ...
              "${selected.evidencesCount} adjuntos",
            ),
          ),
        ],
      ),
  ...
  Widget _footer(String folio, int version) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Flexible(child: _versionChip("Folio: $folio (v$version)", primaryRed)),
