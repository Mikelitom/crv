...
class _ServiceDetailViewState extends ConsumerState<ServiceDetailView> {
  ...
  Widget _buildEvidenciasList(List<ServiceOrderModel> services) {
    final servicesWithEvidence = services
        .where((s) => s.evidences.isNotEmpty)
        .toList();
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "${service.evidences.length} archivos asociados",
                        style: TextStyle(
                          fontSize: 10,
  ...
  void _showServiceEvidenceDialog(
    ...
    final String displayReportId = service.reportId.isNotEmpty
        ? (service.reportId.length >= 6
              ? service.reportId.substring(0, 6).toUpperCase()
              : service.reportId.toUpperCase())
        : "N/A";
                        ...
                        itemBuilder: (_, index) {
                          ...
                          return ExpansionTile(
                            ...
                            children: files.map((evidence) {
                              final isImage =
                                  evidence.mimeType.contains("image") ||
                                  _isImageExtension(evidence.fileName);
                              final fileIcon = _getFileIconForEvidence(
                                evidence.fileName,
                                evidence.mimeType,
                              );
  ...
  Widget _buildComponentesList() {
    ...
    if (state.data.isEmpty) {
      return const Padding(
        padding: EdgeInsets.all(20),
        child: Center(child: Text("Sin componentes")),
      );
    }

    final sortedData = List.from(state.data)
      ..sort((a, b) {
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Icon(
                        _getIconForComponent(item.componentName),
                        size: 18,
                        color: color,
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Incidencias: ${item.incidenciasPrevias}",
                            style: const TextStyle(
                              fontSize: 10,
                              color: Colors.grey,
                            ),
  ...
  IconData _getIconForComponent(String name) {
    ...
    if (n.contains("golpes") || n.contains("carroceria"))
                      ...
                      children: [
                        ...
                        Flexible(
                          child: ListView.separated(
                            shrinkWrap: true,
                            itemCount: ref
                                .watch(pendingComponentNotifierProvider)
                                .data
                                .length,
                            ...
                            itemBuilder: (context, i) {
                              final pendingState = ref.watch(
                                pendingComponentNotifierProvider,
                              );
          ...
          children: [
            Expanded(
              child: _buildOrderColumn(
                "PENDIENTES",
                pending,
                const Color.fromARGB(255, 194, 24, 21),
                context,
                ref,
              ),
            ),
  ...
  Widget _buildOrderList(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) =>
          _buildServiceOrderItem(orders[index], context, ref),
    );
  }
  ...
  Widget _buildServiceOrderItem(
    ...
    final buttonText = isPending
        ? "INICIAR"
        : (isInProgress ? "COMPLETAR" : "COMPLETADA");
    final statusColor = isCompleted
        ? Colors.green
        : (isInProgress
              ? Colors.orange
              : const Color.fromARGB(255, 227, 18, 18));
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  height: 32,
                  child: ElevatedButton(
                    onPressed: isCompleted || completeState.loading
                        ? null
                        : () async {
                            if (isPending) {
                      ...
                      children: [
                        ...
                        Flexible(
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              final model =
                                  state.items[index] as ServiceItemModel;
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        Text(
                          _getSpanishMonth(h.inspectionDate.month),
                          style: const TextStyle(
                            fontSize: 9,
                            color: Colors.red,
                            fontWeight: FontWeight.bold,
