  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        height: 380, // Altura fija para alineación con otros widgets
          ...
          data: (orders) {
            ...
            return Column(
              ...
              children: [
                ...
                const Spacer(), // Empuja el botón al final del contenedor
                ...
                if (lastOrder != null)
                  ...
                  const Center(
                    child: Text("No hay órdenes pendientes", style: TextStyle(color: Colors.grey)),
                  ),
              ],
            );
          },
