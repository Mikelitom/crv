...
class PendingMaintenanceWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PendingMaintenanceWidget> createState() =>
      _PendingMaintenanceWidgetState();
}

class _PendingMaintenanceWidgetState
    extends ConsumerState<PendingMaintenanceWidget> {
          ...
          builder: (context, constraints) {
            return pendingAsync.when(
              ...
              data: (orders) {
                ...
                final progressCount = orders.where((o) {
                  final status = o['status']?.toString().toUpperCase() ?? '';
                    ...
                    AnimatedSwitcher(
                      ...
                      child: lastOrder != null
                          ? InkWell(
                              ...
                              onTap: () => widget.onNavigateToPress(
                                lastOrder['press_id'],
                              ),
